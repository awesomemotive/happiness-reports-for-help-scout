...
return(pointIndex>=this.scale.valuesCount||0>pointIndex)&&(pointIndex=0),fromCenter.distance<=this.scale.drawingArea&&helpers.each(this.datasets,function(dataset){activePointsCollection.push(dataset.points[pointIndex])}),activePointsCollection},buildScale:function(data){this.scale=new Chart.RadialScale({display:this.options.showScale,fontStyle:this.options.scaleFontStyle,fontSize:this.options.scaleFontSize,fontFamily:this.options.scaleFontFamily,fontColor:this.options.scaleFontColor,showLabels:this.options.scaleShowLabels,showLabelBackdrop:this.options.scaleShowLabelBackdrop,backdropColor:this.options.scaleBackdropColor,backdropPaddingY:this.options.scaleBackdropPaddingY,backdropPaddingX:this.options.scaleBackdropPaddingX,lineWidth:this.options.scaleShowLine?this.options.scaleLineWidth:0,lineColor:this.options.scaleLineColor,angleLineColor:this.options.angleLineColor,angleLineWidth:this.options.angleShowLineOut?this.options.angleLineWidth:0,pointLabelFontColor:this.options.pointLabelFontColor,pointLabelFontSize:this.options.pointLabelFontSize,pointLabelFontFamily:this.options.pointLabelFontFamily,pointLabelFontStyle:this.options.pointLabelFontStyle,height:this.chart.height,width:this.chart.width,xCenter:this.chart.width/2,yCenter:this.chart.height/2,ctx:this.chart.ctx,templateString:this.options.scaleLabel,labels:data.labels,valuesCount:data.datasets[0].data.length}),this.scale.setScaleSize(),this.updateScaleRange(data.datasets),this.scale.buildYLabels()},updateScaleRange:function(datasets){var valuesArray=function(){var totalDataArray=[];return helpers.each(datasets,function(dataset){dataset.data?totalDataArray=totalDataArray.concat(dataset.data):helpers.each(dataset.points,function(point){totalDataArray.push(point.value)})}),totalDataArray}(),scaleSizes=this.options.scaleOverride?{steps:this.options.scaleSteps,stepValue:this.options.scaleStepWidth,min:this.options.scaleStartValue,max:this.options.scaleStartValue+this.options.scaleSteps*this.options.scaleStepWidth}:helpers.calculateScaleRange(valuesArray,helpers.min([this.chart.width,this.chart.height])/2,this.options.scaleFontSize,this.options.scaleBeginAtZero,this.options.scaleIntegersOnly);helpers.extend(this.scale,scaleSizes)},addData:function(valuesArray,label){this.scale.valuesCount++,helpers.each(valuesArray,function(value,datasetIndex){var pointPosition=this.scale.getPointPosition(this.scale.valuesCount,this.scale.calculateCenterOffset(value));this.datasets[datasetIndex].points.push(new this.PointClass({value:value,label:label,x:pointPosition.x,y:pointPosition.y,strokeColor:this.datasets[datasetIndex].pointStrokeColor,fillColor:this.datasets[datasetIndex].pointColor}))},this),this.scale.labels.push(label),this.reflow(),this.update()},removeData:function(){this.scale.valuesCount--,this.scale.labels.shift(),helpers.each(this.datasets,function(dataset){dataset.points.shift()},this),this.reflow(),this.update()},update:function(){this.eachPoints(function(point){point.save()}),this.reflow(),this.render()},reflow:function(){helpers.extend(this.scale,{width:this.chart.width,height:this.chart.height,size:helpers.min([this.chart.width,this.chart.height]),xCenter:this.chart.width/2,yCenter:this.chart.height/2}),this.updateScaleRange(this.datasets),this.scale.setScaleSize(),this.scale.buildYLabels()},draw:function(ease){var easeDecimal=ease||1,ctx=this.chart.ctx;this.clear(),this.scale.draw(),helpers.each(this.datasets,function(dataset){helpers.each(dataset.points,function(point,index){point.hasValue()&&point.transition(this.scale.getPointPosition(index,this.scale.calculateCenterOffset(point.value)),easeDecimal)},this),ctx.lineWidth=this.options.datasetStrokeWidth,ctx.strokeStyle=dataset.strokeColor,ctx.beginPath(),helpers.each(dataset.points,function(point,index){0===index?ctx.moveTo(point.x,point.y):ctx.lineTo(point.x,point.y)},this),ctx.closePath(),ctx.stroke(),ctx.fillStyle=dataset.fillColor,ctx.fill(),helpers.each(dataset.points,function(point){point.hasValue()&&point.draw()})},this)}})}.call(this);var greatData=[{value:hrfhs_vars.great,color:hrfhs_vars.color_great},{value:100-hrfhs_vars.great,color:hrfhs_vars.color_empty}],okayData=[{value:hrfhs_vars.okay,color:hrfhs_vars.color_okay},{value:100-hrfhs_vars.okay,color:hrfhs_vars.color_empty}],notGoodData=[{value:hrfhs_vars.notGood,color:hrfhs_vars.color_not_good},{value:100-hrfhs_vars.notGood,color:hrfhs_vars.color_empty}];window.onload=function(){var chartGreat=jQuery(".chart-great");chartGreat&&jQuery.each(chartGreat,function(index,value){var ctxGreat=jQuery(this)[0].getContext("2d");window.myDoughnut=new Chart(ctxGreat).Doughnut(greatData,{animation:hrfhs_vars.animation,responsive:!0,percentageInnerCutout:80,animationEasing:hrfhs_vars.animation_easing,animateScale:!1,segmentStrokeWidth:0,segmentStrokeColor:hrfhs_vars.segment_stroke_color,animationSteps:50,showTooltips:!1})});var chartOkay=jQuery(".chart-okay");chartOkay&&jQuery.each(chartOkay,function(index,value){var ctxOkay=jQuery(this)[0].getContext("2d");window.myDoughnut=new Chart(ctxOkay).Doughnut(okayData,{animation:hrfhs_vars.animation,responsive:!0,percentageInnerCutout:80,animationEasing:hrfhs_vars.animation_easing,animateScale:!1,segmentStrokeWidth:0,segmentStrokeColor:hrfhs_vars.segment_stroke_color,animationSteps:50,showTooltips:!1})});var chartNotGood=jQuery(".chart-not-good");chartNotGood&&jQuery.each(chartNotGood,function(index,value){var ctxNotGood=jQuery(this)[0].getContext("2d");window.myDoughnut=new Chart(ctxNotGood).Doughnut(notGoodData,{animation:hrfhs_vars.animation,responsive:!0,percentageInnerCutout:80,animationEasing:hrfhs_vars.animation_easing,animateScale:!1,segmentStrokeWidth:0,segmentStrokeColor:hrfhs_vars.segment_stroke_color,animationSteps:50,showTooltips:!1})})};